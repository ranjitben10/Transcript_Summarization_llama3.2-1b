...
# Install Ollama (you may need to adjust the installation command based on the official documentation)
...
# This part requires using a shell to run multiple commands
